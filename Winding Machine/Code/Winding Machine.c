...
void screenRefresh(){
     ...
     switch(menu){
        case 1:
            speed11(menu11); //Number of turns
        ...
        case 2:
            ...
            break;
        case 3:
            speed11(menu31); // Wire width
            writeNumber(wireWidth, 3, 0);
            speed27(menu32); // mm NEXT
            break;
        case 4:
            writeNumber(wireWidth, 3, 0);
            speed27(menu42); // mm <NEXT>
            break;
        case 5:
            speed11(menu51); // Coil length
        ...
        case 6:
            ...
            break;
        case 7:
            speed11(menu71); // Settings
            speed21(menu72); // <SKIP> ENTER
            break;
        case 8:
            speed21(menu82); // SKIP <ENTER>
            break;
        case 9:
            speed11(menu91); // Move carriage
            speed21(menu92); // <<o  <    >   >>
            break;
        case 10:
            speed21(menu102); // <<   <o   >   >>
        ...
        case 13:
            ...
            break;
        case 14:
            speed11(menu141); // Setup saved
            speed21(menu142); // <MENU> START
            break;
        case 15:
            speed21(menu152); // MENU <START>
            break;
        case 16:
            speed11(menu161); // Progress
            writeNumber(currentNumberOfTurns, 0, 0);
            Lcd_Out(2, 7, " of ");
            writeNumber(numberOfTurns, 0, 10);
            break;
        case 17:
            speed11(menu171); // Progress paused
            writeNumber(currentNumberOfTurns, 0, 0);
            Lcd_Out(2, 7, " of ");
            writeNumber(numberOfTurns, 0, 10);
            break;
        case 18:
            speed11(menu181); // Steps per turn
        ...
        case 21:
            ...
            break;
        case 22:
            speed11(menu221); // Step delay in ms
        ...
        case 23:
            ...
            break;
        case 24:
            speed11(menu241); // Settings saved
            speed21(menu242); // <MENU> SETTINGS
            break;
        case 25:
            speed21(menu252); // MENU <SETTINGS>
            break;
     }
}
